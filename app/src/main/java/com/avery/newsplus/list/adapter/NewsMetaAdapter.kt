...
class NewsMetaAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) = holder.onBind(getItem(position)!!).also {
    ...
    companion object {
        private val DIFF_CALLBACK = object : DiffUtil.ItemCallback<NewsMetaItem>() {
            override fun areItemsTheSame(oldItem: NewsMetaItem, newItem: NewsMetaItem) = oldItem.aid == newItem.aid

            override fun areContentsTheSame(oldItem: NewsMetaItem, newItem: NewsMetaItem) = oldItem.aid == newItem.aid
        }
    }
    ...
    class ViewHolder(
        ...
        fun onBind(newsMetaItem: NewsMetaItem) {
            ...
            tvCommentCount.text = containerView.resources.getString(R.string.comment_count, newsMetaItem.replyCount)
